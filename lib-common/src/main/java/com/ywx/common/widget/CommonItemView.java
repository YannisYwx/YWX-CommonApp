...
public class CommonItemView extends ConstraintLayout {
    ...
    private boolean hasBottomLine = true, hasArrow = true, hasSwitchButton = false, isChecked = false;
    ...
    private void init(@NonNull Context context, @Nullable AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            hasSwitchButton = typedArray.getBoolean(R.styleable.CommonItemView_hasSwitchButton, false);
            isChecked = typedArray.getBoolean(R.styleable.CommonItemView_isChecked, false);
    ...
    protected void onFinishInflate() {
        ...
        sbToggle = findViewById(R.id.sbToggle);
        setDataToUi();
    ...
    private void setDataToUi() {
        ...
        if (icon != null) {
            ...
            findViewById(R.id.vStub).setVisibility(View.VISIBLE);
        } else {
            ivIcon.setVisibility(View.GONE);
            findViewById(R.id.vStub).setVisibility(View.GONE);
        }

        if(arrow == null) {
            arrow =  ResourcesCompat.getDrawable(getResources(), R.mipmap.icon_arrow_right, null);
        }

        ivArrow.setImageDrawable(arrow);
        sbToggle.setVisibility(hasSwitchButton ? View.VISIBLE : View.GONE);
        sbToggle.setChecked(isChecked);
        ivArrow.setVisibility(hasArrow && !hasSwitchButton ? View.VISIBLE : View.GONE);
    }
    ...
    public void setData(int iconRes,String label,boolean hasSwitchButton, boolean hasArrow, boolean isChecked){
        this.isChecked = isChecked;
        this.hasSwitchButton = hasSwitchButton;
        setData(iconRes,0,label,null,false,hasArrow);
    }

    public void setData(int iconRes, int arrowRes, @Nullable  String label, @Nullable String textRight, boolean hasShowBottomLine, boolean hasArrow) {
        if (iconRes > 0) {
