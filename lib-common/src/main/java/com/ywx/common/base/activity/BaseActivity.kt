...
import com.ywx.common.base.IBaseView.Companion.SHOW_SPACE
import com.ywx.common.event.ActivityEvent
import com.ywx.common.event.FragmentEvent
import com.ywx.common.ext.toast
import com.ywx.common.mvvm.view.BaseActivity
...
abstract class BaseActivity : AppCompatActivity(), IBaseView, View.OnClickListener,
        Consumer<Disposable>, BackHandledInterface {
     ...
     * 拦截返回键事件的fragment
     */
    private var mHandledBackPressFragment: Fragment? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        bindingView(mRootView)//isBuildModule
        mRouter.inject(this)
    ...
    override fun setHandedBackPressFragment(fragment: Fragment) {
        this.mHandledBackPressFragment = fragment
    }
    ...
    override fun initCommonView() {
        ...
        mLoadService = builder.build().register(mRootView, layoutParams,
                OnReloadListener { v: View? -> this@BaseActivity.onReload(v) }
        )
    ...
    open fun onEvent(event: ActivityEvent?) {
    }
...
////                "我按了返回键 ${supportFragmentManager.fragments.size} --> ${supportFragmentManager.backStackEntryCount}".toast()
...
//    }
    ...
    override fun onBackPressed() {
        mHandledBackPressFragment?.let {
            "onBackPressedSupport ---> ${supportFragmentManager.backStackEntryCount}".toast()
