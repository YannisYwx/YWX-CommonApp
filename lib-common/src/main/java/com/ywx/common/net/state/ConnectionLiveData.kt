...
import com.ywx.common.ext.connectivityManager
...
class ConnectionLiveData(val context: Context) : LiveData<Boolean>() {
    private var connectivityManager: ConnectivityManager = context.connectivityManager!!
    ...
    private fun updateConnection() {
        ...
        postValue(capabilities?.hasCapability(NetworkCapabilities.NET_CAPABILITY_INTERNET))
    }
}