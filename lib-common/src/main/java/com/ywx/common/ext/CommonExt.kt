...
import com.ywx.common.ext.view.clickNoRepeat

/**
 * Author: YWX
 * Date: 2021/9/8 11:32
 * Description: 一些通用的扩展方法
 */
...
fun View.setPaddingStart(id: Int) {
    this.setPaddingRelative(getDimension(id).toInt(), paddingTop, paddingEnd, paddingBottom)
}

fun View.setPaddingEnd(dimId: Int) {
    this.setPaddingRelative(paddingStart, paddingTop, getDimension(id).toInt(), paddingBottom)
}

fun View.setViewPadding(start: Int = paddingStart, top: Int = paddingTop, end: Int = paddingEnd, bottom: Int = paddingBottom) {
